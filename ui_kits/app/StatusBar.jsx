// iPhone-style status bar — 9:41, signal / wifi / battery. Matches the
// Figma "Status Bar / iPhone 13 Mini" (black glyphs on white).
function StatusBar() {
  return (
    <div style={{
      height: 47, flex: "none", display: "flex", alignItems: "center",
      justifyContent: "space-between", padding: "0 24px 0 34px",
    }}>
      <span style={{
